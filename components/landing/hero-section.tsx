          ...
          <div className="text-center lg:text-left">
            <FadeIn delay={0}>
              <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-border bg-muted/50 px-4 py-1.5 text-sm">
                ...
                <span className="text-muted-foreground">University of Barishal - CSE Department</span>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={0.2}>
              <p className="mb-8 max-w-2xl text-pretty text-lg text-muted-foreground md:text-xl">
                A comprehensive platform designed to simplify class scheduling, attendance tracking, 
                resource sharing, and communication for students, teachers, and administrators.
              </p>
            </FadeIn>
              ...
              <div className="relative">
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-border/50 hover-scale">
                  <Image
                    ...
                    alt="Students using SmartCSE platform"
                    width={600}
                    height={400}
                ...
                <FadeIn delay={0.6} direction="right">
                  <div className="absolute -top-4 -right-4 bg-card p-4 rounded-xl shadow-xl border border-border/50 animate-float" style={{ animationDelay: '1s' }}>
                    <div className="flex items-center gap-3">
