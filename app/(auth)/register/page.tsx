...
import { GraduationCap, BriefcaseBusiness, ArrowRight, ArrowLeft, Loader2, Clock } from "lucide-react"
...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault()
    setIsLoading(true)
    // NextAuth registration logic ekhane thakbe
  ...
  return (
    <div className="min-h-screen flex bg-background">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        <Image src="/images/hero-students.jpg" alt="SmartCSE" fill className="object-cover" priority />
        ...
        <Card className="w-full max-w-2xl border-none shadow-none lg:border lg:shadow-xl lg:bg-card">
          <CardHeader className="text-center pb-2">
            <Link href="/" className="mx-auto mb-6 flex justify-center items-center gap-2">
              ...
              <span className="text-3xl font-black tracking-tighter text-primary italic">SmartCSE</span>
            </Link>
          ...
          <CardContent className="pt-6">
            {/* STEP 1: ENLARGED ROLE SELECTION */}
            {step === 1 && (
              <div className="space-y-10 animate-in fade-in zoom-in-95 duration-500">
                <RadioGroup defaultValue="student" onValueChange={(v) => setRole(v as any)} className="grid grid-cols-2 sm:grid-cols-2 gap-6">
            ...
            {/* STEP 2: FULL FORM WITH EXPERIENCE FIELD */}
            {step === 2 && (
                  ...
                  {role === "student" ? (
                    ...
                    <>
                      ...
                      <div className="space-y-2 col-span-2">
                        ...
                        <Input id="specialization" placeholder="Machine Learning, IoT, Web" value={formData.specialization} onChange={handleChange} />
                      </div>
                    </>
                  )}
